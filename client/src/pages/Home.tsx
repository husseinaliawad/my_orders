...
export function Home() {
  ...
  return <div>
    ...
    <CTASection title="Built for practical sharing with premium controls." description="Admin moderation, item approvals, request status tracking, account blocking, and clear owner/renter flows." buttonLabel="List your first item" onClick={() => nav("/add-item")} />
  </div>;
}
