...
export function Footer() {
  ...
  return <footer className="mt-20 border-t bg-slate-950 px-4 py-12 text-white">
    <div className="mx-auto grid max-w-[96rem] gap-8 md:grid-cols-4">
      ...
      <div><b>Marketplace</b><div className="mt-3 grid gap-2 text-sm text-slate-300"><Link to="/browse">Browse</Link>{user && <><Link to="/add-item">List items</Link><Link to="/requests">Requests</Link></>}</div></div>
